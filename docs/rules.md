...
- Only the *local network master* (L3-Managed switch or router OS) should be connected to your firewall. Isolate your firewall from the rest of your network. Treat it like an Untrusted Entity.
